...
Your task here is to post your name and an animated GIF that represents your experience with this tutorial to the gif repository in the teaminteract organization. Something like this:

Daniel Fuller

![](https://media.giphy.com/media/dJtoGmnupA00QaJitW/giphy.gif)

For this you will need to use your RMarkdown skills.
